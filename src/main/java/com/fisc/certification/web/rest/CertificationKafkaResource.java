...
@RestController
@RequestMapping("/api/certification-kafka")
public class CertificationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CertificationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CertificationKafkaResource(KafkaProperties kafkaProperties) {
